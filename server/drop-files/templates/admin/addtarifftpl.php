                                        ...
                                        <div id="<?php echo "ride-tariffs-".$count ?>" class="col-sm-12 <?php echo "ride-tariffs-".$count ?>" style="display:none;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <?php foreach($rides_array as $ride){ 
                                                            if($ride['id'] == $ridesarray['id'])continue;
                                                    ?>
                                                        <label for="<?php echo "altv-".$ridesarray['id'] . "-" . $ride['id']; ?>"><?php echo $ride['ride_type']; ?></label>
                                                        <input style="margin-right:10px;" type="checkbox" class="t-input" id="<?php echo "altv-".$ridesarray['id'] . "-" . $ride['id']; ?>" name="<?php echo "altv-".$ridesarray['id'] . "-" . $ride['id']; ?>">
                                                    <?php } ?>
                                                </div>
