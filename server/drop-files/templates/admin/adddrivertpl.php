                           ...
                           <div class="form-group">                       
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input  type="text" class="form-control" id="state" placeholder="" name="state" value="<?php echo !empty($_POST["state"]) ? $_POST["state"] : ''; ?>" >
                                </div>
                           ...
                           <br>
                            ...
                            <div class="form-group" id="other-bank-details" style="display:none;">                       
                               <div class="col-sm-6">
                                    ...
                                    <input  type="text" class="form-control" id="other-bank-name" placeholder="" name="other-bank-name" value="<?php echo !empty($_POST["other-bank-name"]) ? $_POST["other-bank-name"] : ''; ?>" >
                                </div>  
                                

                                <div class="col-sm-6">
                                    <label for="other-bank-code"><span style="color:red">*</span>Bank Code</label>
                                    <input  type="text" class="form-control" id="other-bank-code" placeholder="" name="other-bank-code" value="<?php echo !empty($_POST["other-bank-code"]) ? $_POST["other-bank-code"] : ''; ?>" >
                                </div>                                                              
